...
function About() {
    return (
        <div className="px-4 md:px-20 py-10 text-amber-900">
            <div className="flex flex-col md:flex-row items-center md:items-start">
                <div className="w-full md:w-2/3 text-justify animate-fadeInUp">
                    <p className="text-4xl md:text-6xl font-bold animate-fadeInUp"> 
                ...
                <div className="w-full md:w-auto mt-10 md:mt-0 md:ml-20 animate-fadeInUp delay-300">
                    <Image 
                        src="./bitmoji.png" 
                        size="medium" 
                        className="transform transition duration-700 ease-in-out hover:scale-125"
                    />
                </div>
            </div>
        </div>
